...
from posenet.common.utils.vis import vis_keypoints, vis_3d_multiple_skeleton, \
    vis_3d_multiple_skeleton_no_show_but_savefig
...
def main():
    ...
    focal = [1028.72, 1027.73] # x-axis, y-axis
    # focal = [678, 678]
    princpt = [964.459, 557.226]
      # x-axis, y-axis
    ...
    for filename in os.listdir("frames"):
        original_img = cv2.imread(os.path.join("frames",filename))
        ...
        for bb in bbox_list:
            ...
            cv2.rectangle(original_img, start_point, end_point, (0, 255, 0), 2)
        ...
        for n in range(person_num):
            ...
            k_value = np.array([math.sqrt(
                rootnet_cfg.bbox_real[0] * rootnet_cfg.bbox_real[1] * focal[0] * focal[1] / (
